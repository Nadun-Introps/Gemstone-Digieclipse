...
return [
    'users' => [
        'sessions' => [
            ...
            'password'               => 'Password',
            'powered-by-description' => 'Developed by Introps IT',
            'submit-btn'             => 'Sign In',
            'title'                  => 'Sign In',
        ],
    ...
    'bidding' => [
        ...
        'edit' => [
            'title' => 'Edit Bidding Product',
            'subtitle' => 'Update bidding product details',
            'product-info' => 'Product Information',
            'auction-timing' => 'Auction Timing',
            'status' => 'Status',
            'name' => 'Product Name',
            'name-placeholder' => 'Enter product name',
            'starting-price' => 'Starting Price',
            'starting-price-placeholder' => 'Enter starting price',
            'start-date' => 'Start Date',
            ...
            'cancel-btn' => 'Cancel',
            'update-btn' => 'Update Bidding',
            'minimum-increment' => 'Minimum Bid Increment',
            'minimum-increment-placeholder' => 'Enter minimum bid increment',
            'reserve-price' => 'Reserve Price',
            'reserve-price-placeholder' => 'Enter reserve price (optional)',
        ],

        'view' => [
            'title' => 'View Bidding Product',
            'subtitle' => 'View bidding product details',
            'product-info' => 'Product Information',
            'auction-timing' => 'Auction Timing',
            'status' => 'Status',
