...
<div class="mt-10 grid border-b border-zinc-200 max-md:mt-3 max-sm:mt-0">
    <div class="flex gap-x-4 pb-5 max-md:gap-x-3 max-md:pb-4" v-for="item in cart.items">
        ...
        <img class="h-[90px] max-h-[90px] w-[90px] max-w-[90px] rounded-xl max-md:h-20 max-md:max-h-20 max-md:max-w-20 max-md:rounded-lg"
...
<div class="mb-8 mt-6 grid gap-4 max-md:mb-0 max-sm:mt-4 max-sm:gap-2.5">
    ...
    <template v-if="displayTax.subtotal == 'including_tax'">
        <div class="flex justify-between text-right">
            <p class="text-base max-sm:text-sm tex13">
    ...
    <template v-else-if="displayTax.subtotal == 'both'">
        <div class="flex justify-between text-right">
            <p class="text-base max-sm:text-sm tex15">
        ...
        <div class="flex justify-between text-right">
            <p class="text-base max-sm:text-sm tex16">
    ...
    <template v-else>
        <div class="flex justify-between text-right">
            <p class="text-base max-sm:text-sm tex17">
                @lang('shop::app.checkout.onepage.summary.sub-total')
            </p>
    ...
    <div class="flex justify-between text-right" v-if="cart.discount_amount && parseFloat(cart.discount_amount) > 0">
        <p class="text-base max-sm:text-sm tex18">
    ...
    <template v-if="displayTax.shipping == 'including_tax'">
        <div class="flex justify-between text-right">
            <p class="text-base max-sm:text-sm tex19">
    ...
    <template v-else-if="displayTax.shipping == 'both'">
        <div class="flex justify-between text-right">
            <p class="text-base max-sm:text-sm tex20">
        ...
        <div class="flex justify-between text-right">
            <p class="text-base max-sm:text-sm tex21">
    ...
    <template v-else>
        <div class="flex justify-between text-right">
            <p class="text-base max-sm:text-sm tex22">
                @lang('shop::app.checkout.onepage.summary.delivery-charges')
            </p>
