            ...
            <x-shop::drawer>
                ...
                <x-slot:header>
                    ...
                    <div class="flex items-center justify-between">
                        <p class="text-2xl font-medium max-md:text-xl max-sm:text-xl" style="font-size: 1.5rem !important; line-height: 2rem !important;">
                            @lang('shop::app.checkout.cart.mini-cart.shopping-cart')
                        </p>
                    </div>

                    <p class="text-base max-md:text-zinc-500 max-sm:text-xs" style="font-size: 1rem !important; line-height: 1.5rem !important;">
                    ...
                    >
                        ...
                        <div class="grid flex-1 place-content-start justify-stretch gap-y-2.5">
                            <div class="flex justify-between gap-2 max-md:gap-0 max-sm:flex-wrap">
                                ...
                                >
                                        <p class="text-base font-medium max-md:font-normal max-sm:text-sm" style="font-size: 1rem !important; line-height: 1.5rem !important;">
                                            @{{ item.name }}
                                        </p>
                                    </a>
                ...
                >
                    ...
                    >
                        ...
                        <template v-if="! isLoading">
                            <p class="text-sm font-medium text-zinc-500" style="font-size: 0.875rem !important; line-height: 1.25rem !important;">
                        ...
                        <a
                            ...
                            class="mx-auto block w-full cursor-pointer rounded-2xl bg-navyBlue px-11 py-4 text-center text-base font-medium text-white max-md:rounded-lg max-md:px-5 max-md:py-2" style="font-size: 1rem !important; line-height: 1rem !important;"
                        >
                            ...
                            <div class="block cursor-pointer text-center text-base font-medium max-md:py-1.5">
                                <a href="{{ route('shop.checkout.cart.index') }}" style="font-size: 1rem !important; line-height: 1.5rem !important;">
