<x-shop::layouts.account>
    <!-- Page Title -->
    <x-slot:title>
        @lang('shop::app.customers.account.bids.page-title')
        </x-slot>

        <!-- Breadcrumbs -->
        @if ((core()->getConfigData('general.general.breadcrumbs.shop')))
        @section('breadcrumbs')
        <x-shop::breadcrumbs name="bids" />
        @endSection
        @endif
        ...
        <div class="mx-4 flex-auto max-md:mx-6 max-sm:mx-4">
            ...
            {!! view_render_event('bagisto.shop.customers.account.bids.list.before') !!}

            <!-- For Desktop View -->
            <div class="max-md:hidden">
                <x-shop::datagrid :src="route('shop.customers.account.bids.index')" />
            </div>
            ...
            {!! view_render_event('bagisto.shop.customers.account.bids.list.after') !!}
